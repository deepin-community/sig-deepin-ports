...
- `deepin-a733-arm64-25-desktop-installer.sha256sum`
  sha256 校验和
- `deepin-a733-arm64-25-desktop-installer.md5sum`
  md5 校验和
- `deepin-a733-arm64-25-desktop-installer.root.ext4`
  系统根目录分区镜像

校验镜像：

``` shell
$ cat deepin-a733-arm64-25-desktop-installer.sha256sum
[hash sum]  deepin-a733-arm64-25-desktop-installer.root.ext4

$ sha256sum deepin-a733-arm64-25-desktop-installer.root.ext4
[hash sum]  deepin-a733-arm64-25-desktop-installer.root.ext4
```
